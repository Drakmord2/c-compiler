...
public class InternalCLexer extends Lexer {
    ...
    public final void mRULE_TYPELIT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalC.g:6736:14: ( ( 'int' | 'bool' | 'string' | 'void' ) )
            // InternalC.g:6736:16: ( 'int' | 'bool' | 'string' | 'void' )
            {
            // InternalC.g:6736:16: ( 'int' | 'bool' | 'string' | 'void' )
            int alt1=4;
            switch ( input.LA(1) ) {
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalC.g:6748:9: ( ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // InternalC.g:6748:11: ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
            // InternalC.g:6748:11: ( '^' )?
            int alt5=2;
            ...
            // InternalC.g:6748:40: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop6:
            do {
                int alt6=2;
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalC.g:6750:10: ( ( '0' .. '9' )+ )
            // InternalC.g:6750:12: ( '0' .. '9' )+
            {
            // InternalC.g:6750:12: ( '0' .. '9' )+
            int cnt7=0;
            loop7:
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalC.g:6754:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalC.g:6754:19: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // InternalC.g:6754:24: ( options {greedy=false; } : . )*
            loop11:
            do {
                int alt11=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalC.g:6758:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalC.g:6758:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalC.g:6758:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt15=0;
            loop15:
    ...
    static final String DFA16_eotS =
        "\1\uffff\1\53\6\uffff\1\63\5\53\1\uffff\4\53\1\104\3\uffff\2\53\1\113\1\63\2\uffff\2\112\1\47\1\113\1\47\2\uffff\2\47\2\uffff\3\53\11\uffff\2\53\1\127\4\53\1\134\1\uffff\6\53\5\uffff\2\53\10\uffff\1\53\1\146\3\53\1\uffff\1\153\3\53\1\uffff\11\53\1\uffff\4\53\1\uffff\1\174\3\53\1\153\1\53\1\u0081\2\53\1\u0084\1\153\1\53\1\u0086\3\53\1\uffff\1\u008a\1\53\1\u008c\1\53\1\uffff\1\53\1\u008f\1\uffff\1\53\1\uffff\1\u0091\1\153\1\u0092\1\uffff\1\53\1\uffff\1\53\1\u0095\1\uffff\1\53\2\uffff\1\u0097\1\53\1\uffff\1\u0099\1\uffff\1\u009a\2\uffff";
