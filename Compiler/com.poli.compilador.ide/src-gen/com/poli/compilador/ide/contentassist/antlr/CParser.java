		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getCommandAccess().getCommandsAssignment_4_2(), "rule__Command__CommandsAssignment_4_2");
					put(grammarAccess.getCommandAccess().getExpAssignment_4_5(), "rule__Command__ExpAssignment_4_5");
