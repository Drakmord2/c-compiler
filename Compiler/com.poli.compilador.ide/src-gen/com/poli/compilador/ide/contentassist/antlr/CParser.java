		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getFactorAccess().getOpAssignment_0_1(), "rule__Factor__OpAssignment_0_1");
					put(grammarAccess.getFactorAccess().getArgAssignment_0_2(), "rule__Factor__ArgAssignment_0_2");
