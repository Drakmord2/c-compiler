 ...
 * </p>
 * <ul>
 *   <li>{@link com.poli.compilador.c.impl.ArgumentImpl#getExp <em>Exp</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ArgumentImpl extends MinimalEObjectImpl.Container implements Argument
{
  ...
  {
    return CPackage.Literals.ARGUMENT;
  }
  ...
  public EList<Expression> getExp()
  {
    if (exp == null)
    {
      exp = new EObjectContainmentEList<Expression>(Expression.class, this, CPackage.ARGUMENT__EXP);
    }
    return exp;
  }
