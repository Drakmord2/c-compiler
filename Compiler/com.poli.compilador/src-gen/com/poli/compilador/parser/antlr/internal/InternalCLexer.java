...
public class InternalCLexer extends Lexer {
    ...
    public final void mT__37() throws RecognitionException {
        try {
            int _type = T__37;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalC.g:31:7: ( 'print' )
            // InternalC.g:31:9: 'print'
            {
            match("print"); 
    ...
    public final void mRULE_TYPELIT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalC.g:2254:14: ( ( 'int' | 'bool' | 'string' | 'void' ) )
            // InternalC.g:2254:16: ( 'int' | 'bool' | 'string' | 'void' )
            {
            // InternalC.g:2254:16: ( 'int' | 'bool' | 'string' | 'void' )
            int alt1=4;
            switch ( input.LA(1) ) {
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalC.g:2266:9: ( ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // InternalC.g:2266:11: ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
            // InternalC.g:2266:11: ( '^' )?
            int alt5=2;
            ...
            // InternalC.g:2266:40: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop6:
            do {
                int alt6=2;
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalC.g:2268:10: ( ( '0' .. '9' )+ )
            // InternalC.g:2268:12: ( '0' .. '9' )+
            {
            // InternalC.g:2268:12: ( '0' .. '9' )+
            int cnt7=0;
            loop7:
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalC.g:2272:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalC.g:2272:19: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // InternalC.g:2272:24: ( options {greedy=false; } : . )*
            loop11:
            do {
                int alt11=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalC.g:2276:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalC.g:2276:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalC.g:2276:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt15=0;
            loop15:
    ...
    static final String DFA16_eotS =
        "\1\uffff\1\53\5\uffff\1\62\1\53\1\uffff\4\53\1\uffff\4\53\1\104\3\uffff\2\53\1\113\1\62\2\uffff\2\112\1\47\1\113\1\47\2\uffff\2\47\2\uffff\3\53\10\uffff\2\53\1\uffff\1\127\4\53\1\134\1\uffff\6\53\5\uffff\2\53\10\uffff\1\53\1\146\3\53\1\uffff\1\153\3\53\1\uffff\11\53\1\uffff\4\53\1\uffff\1\174\3\53\1\153\1\53\1\u0081\2\53\1\u0084\1\153\1\53\1\u0086\3\53\1\uffff\1\u008a\1\53\1\u008c\1\53\1\uffff\1\53\1\u008f\1\uffff\1\53\1\uffff\1\u0091\1\153\1\u0092\1\uffff\1\53\1\uffff\1\53\1\u0095\1\uffff\1\53\2\uffff\1\u0097\1\53\1\uffff\1\u0099\1\uffff\1\u009a\2\uffff";
